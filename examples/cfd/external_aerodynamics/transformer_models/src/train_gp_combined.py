...
Trains both models jointly with three loss terms:
  ...
  3. Consistency loss between GP-predicted drag and field-integrated drag (detached)
...
def main(cfg: DictConfig):
    ...
    for epoch in range(loaded_epoch, cfg.training.num_epochs):
        ...
        for i, batch in enumerate(train_dl):
            ...
            # ---- Consistency loss (detached full-mesh pass) ----
            c_loss_val = 0.0
            if (
                use_consistency
                and w_gp > 0
                ...
                c_loss = F.mse_loss(gp_mean, transolver_cd.detach())
