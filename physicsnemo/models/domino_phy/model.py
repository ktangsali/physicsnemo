...
class ParameterModel(nn.Module):
    ...
    def __init__(self, input_features: int, model_parameters=None):
        ...
        self.fc2 = nn.Linear(base_layer, int(base_layer))
        self.fc3 = nn.Linear(int(base_layer), int(base_layer))
        self.bn1 = nn.BatchNorm1d(base_layer)           # TODO: these are not used
        self.bn2 = nn.BatchNorm1d(int(base_layer))      # TODO: these are not used
        self.bn3 = nn.BatchNorm1d(int(base_layer))      # TODO: these are not used
                ...
                for p in range(num_sample_points):
                    ...
                    if p == 0:
                        ...
                        if p == 1:
                            ...
                            dist_sum += 1.0 / dist
                if num_sample_points > 1:
                    output_res = 0.5 * output_center + 0.5 * output_neighbor / dist_sum # Heuristic
                else:
